...
function threeEightsSimulation(jackTag = -5, oneEyedJackTag = -14, triggerCount = 2) {
  ...
  let record = (card1, card2, card3) => {
    handsPlayed++;
    if (card1.isEightOfDiamonds() && card2.isEightOfDiamonds() && card3.isEightOfDiamonds()) {
      return 80000;
    } else if (card1.isRedEight() && card2.isRedEight() && card3.isRedEight() ) {
      return 5000;
    } else if (card1.isEight() && card2.isEight() && card3.isEight()) {
      return 500;
    }
    return -1;
  }
